...
function addSwitcher(){
	...
	<a class="sidebar-right-trigger" data-bs-toggle="tooltip" data-placement="right" data-original-title="Change Layout" >
		<span><i class="fa fa-cog fa-spin"></i></span>
	</a>
    <a class="sidebar-close-trigger" ><span><i class="la-times las"></i></span></a>
    <div class="sidebar-right-inner">
        <h4>Pick your style <a onclick="deleteAllCookie()" class="btn btn-primary btn-sm">Delete All Cookie</a></h4>
        <div class="card-tabs">
        ...
        <div class="tab-content tab-content-default tabcontent-border">
            ...
            <div class="note-text">
				<span class="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://coreui.w3itexperts.com/?theme=Gymove" target="_blank">documentation.</a>
			</div>
        </div>
	</div>
</div>`;
	...
	<a class="dz-demo-trigger" data-bs-toggle="tooltip" data-placement="right" data-original-title="Check out more demos" >
		<span><i class="las la-tint"></i></span>
	</a>
    <div class="dz-demo-inner">
		<a class="btn btn-primary btn-sm mb-3" onclick="deleteAllCookie()">Delete All Cookie</a>
        <div class="dz-demo-header">
            <h4 class="text-white">Select Preset Demo</h4>
			<a class="dz-demo-close" ><span><i class="las la-times"></i></span></a>
		</div>
            ...
            <div class="dz-wrapper">
				<div class="row">
					<div class="col-xxl-3 col-md-6 mb-4">
						<div class="overlay-bx rounded-lg dz-demo-bx">
							<div class="overlay-wrapper rounded-lg">
								<img src="assets/images/demo/demo1.webp" alt="" loading="lazy" class="w-100">
							</div>
							<div class="overlay-layer">
								<a data-theme="1" class="btn dz_theme_demo btn-secondary btn-sm me-2">Default</a>
								<a data-theme="1" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a>
							</div>
						</div>
					...
					<div class="col-xxl-3 col-md-6 mb-4">
						<div class="overlay-bx rounded-lg dz-demo-bx">
							<div class="overlay-wrapper rounded-lg">
								<img src="assets/images/demo/demo2.webp" alt="" loading="lazy" class="w-100">
							</div>
							<div class="overlay-layer">
								<a data-theme="2" class="btn dz_theme_demo btn-secondary btn-sm me-2">Default</a>
								<a data-theme="2" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a>
							</div>
						</div>
					...
					<div class="col-xxl-3 col-md-6 mb-4">
						<div class="overlay-bx rounded-lg dz-demo-bx">
							<div class="overlay-wrapper rounded-lg">
								<img src="assets/images/demo/demo3.webp" alt="" loading="lazy" class="w-100">
							</div>
							<div class="overlay-layer">
								<a data-theme="3" class="btn dz_theme_demo btn-secondary btn-sm me-2">Default</a>
								<a data-theme="3" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a>
							</div>
						</div>
					...
					<div class="col-xxl-3 col-md-6 mb-4">
						<div class="overlay-bx rounded-lg dz-demo-bx">
							<div class="overlay-wrapper rounded-lg">
								<img src="assets/images/demo/demo4.webp" alt="" loading="lazy" class="w-100">
							</div>
							<div class="overlay-layer">
								<a data-theme="4" class="btn dz_theme_demo btn-secondary btn-sm me-2">Default</a>
								<a data-theme="4" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a>
							</div>
						</div>
					...
					<div class="col-xxl-3 col-md-6 mb-4">
						<div class="overlay-bx rounded-lg dz-demo-bx">
							<div class="overlay-wrapper rounded-lg">
								<img src="assets/images/demo/demo5.webp" alt="" loading="lazy" class="w-100">
							</div>
							<div class="overlay-layer">
								<a data-theme="5" class="btn dz_theme_demo btn-secondary btn-sm me-2">Default</a>
								<a data-theme="5" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a>
							</div>
						</div>
					...
					<div class="col-xxl-3 col-md-6 mb-4">
						<div class="overlay-bx rounded-lg dz-demo-bx">
							<div class="overlay-wrapper rounded-lg">
								<img src="assets/images/demo/demo6.webp" alt="" loading="lazy" class="w-100">
							</div>
							<div class="overlay-layer">
								<a data-theme="6" class="btn dz_theme_demo btn-secondary btn-sm me-2">Default</a>
								<a data-theme="6" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a>
							</div>
						</div>
					...
					<div class="col-xxl-3 col-md-6 mb-4">
						<div class="overlay-bx rounded-lg dz-demo-bx">
							<div class="overlay-wrapper rounded-lg">
								<img src="assets/images/demo/demo7.webp" alt="" loading="lazy" class="w-100">
							</div>
							<div class="overlay-layer">
								<a data-theme="7" class="btn dz_theme_demo btn-secondary btn-sm me-2">Default</a>
								<a data-theme="7" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a>
							</div>
						</div>
					...
					<div class="col-xxl-3 col-md-6 mb-4">
						<div class="overlay-bx rounded-lg dz-demo-bx">
							<div class="overlay-wrapper rounded-lg">
								<img src="assets/images/demo/demo8.webp" alt="" loading="lazy" class="w-100">
							</div>
							<div class="overlay-layer">
								<a data-theme="8" class="btn dz_theme_demo btn-secondary btn-sm me-2">Default</a>
								<a data-theme="8" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a>
							</div>
						</div>
        ...
        <div class="fs-14 pt-3">
			<span class="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://coreui.w3itexperts.com/?theme=Gymove" target="_blank" class="text-primary">documentation.</a>
		</div>
    </div>
</div>`;
...
(function($) {
	...
	function reinitializeSwitcher() {
		var $switcher = $('.sidebar-right');
		var isRTL = html.attr('dir') === 'rtl' || body.attr('direction') === 'rtl';
		
		$switcher.attr('dir', isRTL ? 'rtl' : 'ltr');
	}
    ...
    themeDirectionSelect.on('change', function() {
		...
		// Bas ye call karo
		setTimeout(reinitializeSwitcher, 50);
	});
	$(document).ready(reinitializeSwitcher);
	$(window).on('load', reinitializeSwitcher);
